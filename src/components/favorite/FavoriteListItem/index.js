    ...
    if (sale > 0) {
      return (
        <div className="favoriteListItem__end">
          ...
          <div className="favoriteListItem__price">
      ...
      <div className="favoriteListItem__body">
        ...
        <div className="favoriteListItem__nav">
          <button
            ...
            onClick={removeFavoriteItemToData}
            className="favoriteListItem__btn"
          >
            X
          </button>
          <button
            ...
            className="favoriteListItem__btn"
          >
            <IcoAddCart className="favoriteListItem__addCart" />
          </button>
        </div>
      </div>
    </>
